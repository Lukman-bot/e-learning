...
<div class="row">
    <div class="col-md-12">
        <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#modal-tambah">
            <i class="fa fa-plus"></i> Add Tahun Pelajaran
        </button>
    </div>
</div>
<hr>
                    ...
                    <?php
                        ...
                        foreach ($data_tapel->result_array() as $showtapel) : 
                            echo "<tr>";
                                ...
                                echo "<td>
                                    <button class='btn btn-danger btn-xs' title='Hapus Tahun Pelajaran' data-toggle='modal' data-target='#modal-hapus-$showtapel[id_tapel]'>
...
<div class="modal fade" id="modal-hapus-<?php echo $showtapel['id_tapel'] ?>">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url() ?>index.php/admin/Tahun_pelajaran/Hapus" method="POST">
                <div class="modal-body">
                    <input type="hidden" name="id_tapel" value="<?php echo $showtapel['id_tapel'] ?>">
                    <p>
                        Apakan anda yakin akan menghapus Data Tahun Pelajaran <b> <?php echo $showtapel['nama_tapel'] ?> </b>
                    </p>
                    <p>NB :</p>
