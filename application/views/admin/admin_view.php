...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <?php 
      $this->load->view('admin/_partials/Navigation_up.php');
    ?>
  </header>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
        <?php 
          $this->load->view('admin/_partials/Navigation.php');
        ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <?php 
        $this->load->view('admin/_partials/Content.php');
      ?>
    </section>
    <!-- /.content -->
  </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a href="#">LASoft</a>.</strong> All rights
    reserved.
