                ...
                <tbody>
                    ...
                    $no=1;
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-xs btn-success" title="Edit Kelas" data-toggle="modal" data-target="#modal-edit-<?php echo $show->id_kelas; ?>">
                                    <li class="fa fa-edit"></li>
                                </button>
                                <button class="btn btn-xs btn-danger" title="Hapus Kelas" data-toggle="modal" data-target="#modal-hapus-<?php echo $show->id_kelas; ?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo base_url(); ?>index.php/admin/Kelas/Hapus">
                    <div class="modal-body">
                        <p>
                            <input type="hidden" name="id_kelas" value="<?php $show->id_kelas ?>">
                        </p>
                        <p>
                            Apakah anda yakin akan menghapus data kelas <b><?php echo $show->nama_kelas; ?></b> tersebut.?
                        </p>
                        <p>
