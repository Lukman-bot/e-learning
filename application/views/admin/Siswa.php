                ...
                <tbody>
                    ...
                    $no=1;
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-xs btn-success" title="Edit Kelas" data-toggle="modal" data-target="#modal-edit-<?php echo $show->id_user; ?>">
                                    <li class="fa fa-edit"></li>
                                </button>
                                <button class="btn btn-xs btn-danger" title="Hapus Kelas" data-toggle="modal" data-target="#modal-hapus-<?php echo $show->id_user; ?>">
	...
	<div class="modal-dialog">
	  <div class="modal-content">
	    ...
	    <div class="modal-body">
	      ...
	      <p>
	      	<input type="password" name="password" class="form form-control" required maxlength="7" value="<?php echo $show->panseword2 ;?>">
	      </p>
	      <p>
	      	Kelas
	      </p>
