...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Apr 2022 pada 20.33
...
INSERT INTO `tbl_mapel` (`id_mapel`, `nama_mapel`, `deskripsi`) VALUES
(2, 'PWPB', 'Pemrograman Web Perangkat Bergerak');
...
--
-- Dumping data untuk tabel `tbl_mapel_kelas_guru_group`
--

INSERT INTO `tbl_mapel_kelas_guru_group` (`id_group`, `id_mapel`, `id_kelas`) VALUES
(2, 1, 6),
(3, 2, 6);
...
INSERT INTO `tbl_materi` (`id_materi`, `id_mapel`, `judul_materi`, `detail_materi`, `video`) VALUES
(1, 2, 'PWPB', '&lt;p&gt;Pemrograman Web Perangkat Bergerak&lt;/p&gt;\r\n', '');
